...
reminder_timer = threading.Thread(target=check_reminder, daemon=True)
reminder_timer.start()

# start the main loop
# stop the timer when the program is exiting
root.protocol("WM_DELETE_WINDOW", lambda: reminder_timer.cancel())
root.mainloop()
