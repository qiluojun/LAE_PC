...
''				prop1					prop2							prop3
OpArray(0, 0) = "M"  : OpArray(0, 1) = "10 10"	: OpArray(0, 2) = NS_SLEEP_MIN
'OpArray(1, 0) = "M" : OpArray(1, 1) = "10 10"	: OpArray(1, 2) = NS_SLEEP_MIN
...
'avoid path with blankspace
strNCmdPath = Chr(34) & strNCmdPath &Chr(34)
