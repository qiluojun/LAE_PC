...
for i, sideline in enumerate(side_line):
    ...
    sideline_message_widget = tk.Message(right_frame, text=sideline_message, width=200, fg="#87CEFA", font=("TkDefaultFont", 12))
...
# Create a variable named "words"
words = tk.StringVar(value="Live and Enjoy!")
...
update_button = tk.Button(left_frame, text="修改今日之言", command=update_words)
