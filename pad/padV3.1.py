...
for i, sideline in enumerate(side_line):
    if i<= 3:
        ...
        sideline_message_widget = tk.Message(right_frame, text=sideline_message, width=400, fg="#87CEFA", font=("TkDefaultFont", 16))
        ...
        sideline_message = f"Name: {sideline['name']}\nLocation: {sideline['location']}\nDate: {sideline['date']}"
        sideline_message_widget = tk.Message(right_frame, text=sideline_message, width=400, fg="#82d2ce", font=("TkDefaultFont", 16))
        sideline_message_widget.grid(row=i-1, column=1, padx=10, pady=10, sticky="w")
        sideline_message_widgets.append(sideline_message_widget)
